...
| **LiteWing ESP32 Drone** | Drone programming using the Crazyflie `cflib` SDK on ESP32-S3 |
| **KiwisIoT** | Documentation platform for an ESP8266/ESP32-based IoT ecosystem |
